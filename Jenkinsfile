pipeline {
	...
	stages{
		stage('Checkout') {
			steps{
				...
				submoduleCfg: [], userRemoteConfigs: [[ credentialsId: 'GitHub_francisco.pacheco',
		 	 	url: 'https://github.com/fpachecoceiba/estacionamiento']]])
			}
		}
	...
	post {
		...
		failure {
			...
			mail (to: 'francisco.pacheco@ceiba.com.co',
